...
//
//  Created by Eric Kazuo  on 14/12/23.
//
...
class ViewController: UIViewController {
    ...
    private lazy var cityLabel: UILabel = {
        let label = UILabel(frame: .zero) // pode usar apenas o inicializador UILabel()
        label.translatesAutoresizingMaskIntoConstraints = false
        label.font = UIFont.systemFont(ofSize: 20, weight: .medium)
        label.text = "São Paulo"
        label.textAlignment = .center
        label.textColor = UIColor.pColor
        return label
    }()
    ...
    private lazy var weatherIcon: UIImageView = {
        ...
        imageView.translatesAutoresizingMaskIntoConstraints = false
        imageView.image = UIColor.sunIcon
    ...
    private lazy var stacksStackView: UIStackView = {
        ...
        stackView.translatesAutoresizingMaskIntoConstraints = false
        stackView.spacing = 3
        stackView.backgroundColor = UIColor.stackBackgroundColor
    ...
    private func setConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            headerView.heightAnchor.constraint(equalToConstant: 149)
        ])
